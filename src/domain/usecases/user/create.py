...
class CreateUserUsecase:
    ...
    async def execute(self, user_plain_credentials: entities.user.PlainCredentials) -> None:
        ...
        await self._user_repository.create_user(safe_credentials_entity=safe_credentials)
